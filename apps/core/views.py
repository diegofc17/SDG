...
def dashboard(request):
    ...
    elif profile.dependencia_id:
        scope_docs = docs.filter(dependencia=profile.dependencia)
        scope_expedientes = Expediente.objects.filter(dependencia=profile.dependencia)
        scope_label = profile.dependencia.display_label
    else:
    ...
    return render(
        ...
        "dashboard.html",
        {
            ...
            "profile_dependencia": profile.dependencia,
            "totals": totals,
