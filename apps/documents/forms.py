...
from .models import Document, Expediente, SerieDocumental, SubserieDocumental, TipoDocumental
...
class DocumentForm(forms.ModelForm):
    def __init__(self, *args, dependencia=None, **kwargs):
        ...
        # Tipo documental: opcional y habilitado
        self.fields["tipo_documental"].required = False
        self.fields["tipo_documental"].help_text = "Opcional. Selecciona el tipo documental específico si aplica."
